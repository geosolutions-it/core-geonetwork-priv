...
<xsl:stylesheet version="1.0" xmlns:xsl ="http://www.w3.org/1999/XSL/Transform"
        ...
        <xsl:template mode="iso19139" match="*[@gco:nilReason='missing' and count(*)=0 and not(geonet:element)]"/>
                            ...
                            <xsl:choose>
                                <xsl:when test="(contains($protocol,'-get-map'))">
                                    <link type="idownload">
                                        ...
                                        <xsl:value-of select="concat('javascript:addWMSLayer([[&#34;' , $name , '&#34;,&#34;' ,  $linkage, '&#34;,&#34;' , $uuid,  '&#34;, &#34;', $name  ,'&#34;,&#34;',$id,'&#34;,&#34;','true','&#34;]])')"/>
                                    </link>
                                    <link type="wms">
                                        <!--<xsl:value-of select="concat('javascript:popInterMap(&#34;',/root/gui/url,'/intermap/srv/',/root/gui/language,'/map.addServicesExt?url=',$linkage,'&amp;service=',$name,'&amp;type=2&#34;)')"/>-->
                                        <!--xsl:value-of select="concat('javascript:runIM_addService(&#34;'  ,  $linkage  ,  '&#34;, &#34;', $name  ,'&#34;, 2)' )"/-->
