			...
			<div>		
				<table class="advsearchfields" width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="center" style="background-color:#1e800c; width: auto; white-space: nowrap; padding-bottom: 8px; vertical-align: bottom; cursor:hand;  cursor:pointer;" onclick="runSimpleSearch();" >
							<font color="#FFFFFF"><strong><xsl:value-of select="/root/gui/strings/search"/></strong></font>
						</td>
...
<xsl:template name="adv_what">
	...
	<!-- Either Of The Words -->	
	<div class="row">  <!-- div row-->
		<span class="labelField"><xsl:value-of select="/root/gui/strings/searchEitherOfTheWords"/></span>
    ...
    <div class="row" id="phrase_search_row" style="display:none">  <!-- div row-->
		<span class="labelField"><xsl:value-of select="/root/gui/strings/searchExactPhrase"/></span>
		<input name="phrase" id="phrase" class="content" size="31" value=""/>
	</div>
	
	<!-- All Text -->
    <div class="row" id="all_search_row" style="display:none">  <!-- div row-->
		<span class="labelField"><xsl:value-of select="/root/gui/strings/searchAllText"/></span>
		<input name="all" id="all" class="content" size="31" value=""/>
	</div>
	
	<!-- Without Words -->
	<div class="row" id="without_search_row" style="display:none">  <!-- div row-->
		<span class="labelField"><xsl:value-of select="/root/gui/strings/searchWithoutWords"/></span>
	...
	<div class="row">  <!-- div row-->
		...
		<span title="{/root/gui/strings/searchhelp/keywords}">
			<input id="themekey" name="themekey" onClick="javascript:popKeyword (this, $('keywordSelectorFrame'));"
				class="content" size="31" value="{/root/gui/searchDefaults/themekey}"/>
		</span>
